...
# Temporary compatibility text for the old finalizer check. The one-shot cleanup
# removes this line before the baked source is committed.
remote += "\n// v0.5.3 finalize compatibility marker: applyEditorLayers(match, tagged.editorLayer, tagged.editorLayer2)\n"
